...
describe('Icon', () => {
  mountTest(ActiveFilled);

  it('should render to a <span class="xxx"><svg>...</svg></span>', () => {
    const wrapper = render(<ActiveFilled className="my-icon-classname" />);
  ...
  it('should support event listeners', () => {
    ...
    const wrapper = mount(
      <div>
        <ActiveFilled onClick={onClickHandler} />
      </div>,
    );
    expect(wrapper).toMatchSnapshot();
  ...
  it('should support two-tone icon', () => {
    let wrapper = render(<ActiveFilled twoToneColor="#f5222d" />);
    expect(wrapper).toMatchSnapshot();
  });
